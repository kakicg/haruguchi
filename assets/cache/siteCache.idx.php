...
$c['use_editor'] = "0";
$c['use_browser'] = "1";
$c['rb_base_dir'] = "/home/haruguchi/www/assets/";
...
$c['show_preview'] = "0";
$c['filemanager_path'] = "/home/haruguchi/www/";
$c['theme_refresher'] = "";
$c['manager_layout'] = "4";
...
$m[] = array('0' => '1');
$d['main.css'] = 2;
$a[2] = array('id' => 2, 'alias' => 'main.css', 'path' => '');
$m[] = array('0' => '2');
$d['index_en'] = 3;
$a[3] = array('id' => 3, 'alias' => 'index_en', 'path' => '');
$m[] = array('0' => '3');
$d['biography'] = 4;
$a[4] = array('id' => 4, 'alias' => 'biography', 'path' => '');
$m[] = array('0' => '4');
$d['biography_en'] = 5;
$a[5] = array('id' => 5, 'alias' => 'biography_en', 'path' => '');
$m[] = array('0' => '5');
$d['works'] = 6;
$a[6] = array('id' => 6, 'alias' => 'works', 'path' => '');
$m[] = array('0' => '6');
$d['works_en'] = 7;
$a[7] = array('id' => 7, 'alias' => 'works_en', 'path' => '');
$m[] = array('0' => '7');
$c = &$this->contentTypes;
$c[1] = 'text/html';
$c[2] = 'text/css';
...
<form method="post" action="[~[*id*]~]" id="ContactForm" name="ContactForm">
    <div class="form_item_row">
<div class="item-title">お名前 / Your name<span class="error"></div>
    <input name="name" type="text" id="name" size="30" class="input_text" eform="Name::1" /><div class="clear"></div>
    </div>
    <div class="form_item_row"><div class="item-title">メールアドレス / e-Mail address</div>
    <input name="mail" type="text" id="mail" size="30" class="input_text"  eform="Email:email:1"  /><div class="clear"></div>
    </div>
    
<div id="mtype" class="form_item_row">
    <input name="mtype" type="radio" id="mtype1" value="message"  />
    メッセージ / Message<br />
    <input type="radio" name="mtype" id="mtype2" value="works"  />作品に関する問い合わせ / About His Works<br />
    <input type="radio" name="mtype" id="mtype3" value="others"  />その他 / Others  </div>    <label><div class="item-title">本文 / Body</div>
...
#page {
	width: 360px;
	background-image:url(../images/gashuu.jpg);
...
$s['alias'] = '
$array = split("_", $current_page);
return $array[0];
';
$s['choose_lang'] = '
$array = split( "_",$current_page);
if( empty( $array[1])) return $jp_name;
else return $en_name;
';
$s['is_active'] = '
$array = split( "_",$current_page);
if( empty( $array[1])) $jcurrent_lang = "jp";
else $jcurrent_lang = "en";

if($jcurrent_lang === $chk_lang ) return \'class="active"\';
else return \'class="inactive"\';
';
$s['thumbnails'] = '
$hostname = "mysql36.db.sakura.ne.jp";
	$database = "haruguchi";
	$username = "haruguchi";
	$password = "cgkojo";
	...
	// SQL クエリを実行します。  
	$query_recordset1 = "SELECT * FROM works2 ORDER BY code2";
	$res = mysql_query($query_recordset1) or die(mysql_error());
	while($work = mysql_fetch_assoc($res)) { 
		if($work["display"]) {
			if($lang === "jp") $title = $work[\'title\'];
			else $title = $work[\'title_en\'];
			$year = $work[\'year\'];
			if(ereg("^([0-9]{4}).*$", $work[\'year\'], $figs)) $year = $figs[1];
			$output = \'<a href="assets/images/display/\'.$work["code"] .\'.jpg"\';
 			$output .= \' rel="lightbox[works]" title="\'.$title.\', \'.$year.\'<br />\';
 			$output .= $work[\'size\'].\'">\';
 			$output .= \'<img src="assets/images/thumbnail/\'.$work["code"].\'.jpg"\';
 			$output .=  \' alt="\';
 			$output .=  $work["code"] .\'" width="80" height="80" /></a>\';
 			echo $output;
		}
	}
