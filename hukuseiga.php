...
$site_top = "http://haruguchi.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "kakicg@cgkojo.com,kakicg@me.com";
...
$Referer_check_domain = "haruguchi.jp";
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('メールアドレス','輪廻 - 犬の話','通り過ぎる馬 - ウィスコンシン通り','転生の部屋','風景 - 二人の椅子');
...
<head>
    ...
    <title>春口光義ウェブサイト | 春口光義複製画注文の確認画面</title>
    <link href="main2.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<!-- ▼************ 送信内容表示部　※編集は自己責任で ************ ▼-->
	<div class="hukuseiga-kakunin" id="formWrap">
		<?php if($empty_flag == 1){ ?>
		<div align="center">
...
<body>
		...
		ご注文ありがとうございました。<br />
		送信は正常に完了しました。<br />
		早急に注文内容、送料、支払い方法をメールでお知らせします。<br /><br />
		春口　光義
